	...
	<xsl:template match="/" >
		<html xml:lang="en" lang="en">
			<head>
				...
				<link rel="stylesheet" href="./styles/recipes.css" type="text/css" />
			...
			<body>
				<h1><a name="top">Specific Carbohydrate Diet recipes</a></h1>
				<h2>Contents</h2>
				<ul>
				<xsl:for-each select="/recipes/section">
				...
				<a href="Dictionary of Units.html">Unit Conversions</a> | 
				<a href="Conversions.html">Temperature Conversions (MathML)</a>
				
				<h2>Recipes</h2>
				<xsl:apply-templates select="/recipes/section">
					<xsl:sort>select="@type"</xsl:sort>
				</xsl:apply-templates>
